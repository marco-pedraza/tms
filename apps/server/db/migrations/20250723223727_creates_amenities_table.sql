...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "service_type_amenities" (
	"id" bigserial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "service_type_amenities" ADD CONSTRAINT "service_type_amenities_service_type_id_service_types_id_fk" FOREIGN KEY ("service_type_id") REFERENCES "public"."service_types"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "service_type_amenities" ADD CONSTRAINT "service_type_amenities_amenity_id_amenities_id_fk" FOREIGN KEY ("amenity_id") REFERENCES "public"."amenities"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "installation_amenities_installation_id_amenity_id_index" ON "installation_amenities" USING btree ("installation_id","amenity_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "service_type_amenities_amenity_id_index" ON "service_type_amenities" USING btree ("amenity_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "service_type_amenities_service_type_id_amenity_id_index" ON "service_type_amenities" USING btree ("service_type_id","amenity_id");