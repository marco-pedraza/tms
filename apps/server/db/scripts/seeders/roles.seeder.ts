...
const PREDEFINED_ROLES = [
  {
    ...
    permissions: [
      ...
      'users_createrole',
      'users_getrole',
      'users_getrolewithpermissions',
      'users_listroles',
      'users_listroleswithpermissions',
      'users_listroleswithpagination',
      'users_listroleswithpermissionsandpagination',
      'users_updaterole',
      'users_assignpermissionstorole',
      'users_deleterole',
      'users_searchroles',
      'users_searchrolespaginated',
