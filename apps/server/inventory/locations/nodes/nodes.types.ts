...
import type { InstallationWithDetails } from '@/inventory/locations/installations/installations.types';
import type { Label } from '@/inventory/locations/labels/labels.types';
import type { NodeEventFlat } from '@/inventory/locations/node-events/node-events.types';
