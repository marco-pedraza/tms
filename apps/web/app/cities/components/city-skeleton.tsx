      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-start">
              <div className="font-medium">{tCommon('fields.slug')}:</div>
              <Skeleton className="h-6 w-32" />
            </div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-start">
              <div className="font-medium">{tCommon('fields.latitude')}:</div>
              <Skeleton className="h-6 w-24" />
            </div>

            <div className="flex justify-between items-start">
              <div className="font-medium">{tCommon('fields.longitude')}:</div>
              <Skeleton className="h-6 w-24" />
            </div>
