...
export namespace inventory {
    ...
    export class ServiceClient {
         ...
         */
        public async listCities(params: shared.PaginationParams): Promise<cities.PaginatedCities> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/cities`, undefined, {query})
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "server-nest-8sci-Generated-TS-Client (Encore/v1.46.17)";
        }
