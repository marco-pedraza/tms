// Code generated by the Encore v1.46.22 client generator. DO NOT EDIT.
...
export namespace inventory {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.assignDriverToBus = this.assignDriverToBus.bind(this)
            this.assignDriverToBusLine = this.assignDriverToBusLine.bind(this)
            this.assignDriverToTransporter = this.assignDriverToTransporter.bind(this)
            ...
            this.listDriversByBus = this.listDriversByBus.bind(this)
            this.listDriversByBusLine = this.listDriversByBusLine.bind(this)
    ...
    priceMultiplier?: number
         ...
         */
        public async createSeatLayoutModel(params: seat_layout_models.CreateSeatLayoutModelPayload): Promise<seat_layout_models.SeatLayoutModel> {
            // Now make the actual call to the API
    ...
    seatsCreated: number
         ...
         */
        public async deleteSeatLayoutModel(id: number): Promise<seat_layout_models.SeatLayoutModel> {
            // Now make the actual call to the API
    ...
    allowedTransitions: buses.BusStatus[]
         ...
         */
        public async getSeatLayoutModel(id: number): Promise<seat_layout_models.SeatLayoutModel> {
            // Now make the actual call to the API
         ...
         * @throws {APIError} If retrieval fails
         */
        public async listDrivers(params: drivers.DriversQueryOptions): Promise<drivers.Drivers> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/get-drivers`, JSON.stringify(params))
         ...
         * @throws {APIError} If retrieval fails
         */
        public async listDriversPaginated(params: drivers.PaginationParamsDrivers): Promise<drivers.PaginatedDrivers> {
            // Now make the actual call to the API
         ...
         * @throws {APIError} If retrieval fails
         */
        public async listSeatLayoutModels(): Promise<seat_layout_models.SeatLayoutModels> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/get-seat-layout-models`)
            return await resp.json() as seat_layout_models.SeatLayoutModels
        }
         ...
         * @throws {APIError} If retrieval fails
         */
        public async listSeatLayoutModelsPaginated(params: shared.PaginationParams): Promise<seat_layout_models.PaginatedSeatLayoutModels> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/get-seat-layout-models/paginated`, JSON.stringify(params))
            return await resp.json() as seat_layout_models.PaginatedSeatLayoutModels
        }
        ...
        public async listStates(params: states.StatesQueryOptions): Promise<states.States> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/get-states`, JSON.stringify(params))
         ...
         */
        public async listStatesPaginated(params: states.PaginationParamsStates): Promise<states.PaginatedStates> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/get-states/paginated`, JSON.stringify(params))
    ...
    term: string
         ...
         * @throws {APIError} If search fails or no searchable fields are configured
         */
        public async searchDrivers(params: {
    term: string
}): Promise<drivers.Drivers> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                term: params.term,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/drivers/search`, undefined, {query})
            return await resp.json() as drivers.Drivers
        }
         ...
         * @throws {APIError} If search fails or no searchable fields are configured
         */
        public async searchDriversPaginated(params: {
    page?: number
    pageSize?: number
    orderBy?: {
    ...
    term: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/drivers/search/paginated`, JSON.stringify(params))
            return await resp.json() as drivers.PaginatedDrivers
        }
    ...
    term: string
         ...
         */
        public async searchStates(params: {
    term: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/states/search`, undefined, {query})
            return await resp.json() as states.States
        }
         ...
         */
        public async searchStatesPaginated(params: {
    page?: number
    pageSize?: number
    orderBy?: {
    ...
    term: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/states/search/paginated`, JSON.stringify(params))
            return await resp.json() as states.PaginatedStates
        }
    ...
    priceMultiplier?: number
         ...
         */
        public async updateSeatLayoutModel(id: number, params: {
    /**
     ...
     * Configuration of seats per floor
     */
    seatsPerFloor?: seat_layout_models.FloorSeats[]

    /**
     * Rows with bathrooms
     */
    bathroomRows?: seat_layout_models.BathroomLocation[]
     ...
     */
    active?: boolean
}): Promise<seat_layout_models.SeatLayoutModel> {
            // Now make the actual call to the API
...
export namespace seat_layout_models {
    ...
    export interface PaginatedSeatLayoutModels {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "server-nest-8sci-Generated-TS-Client (Encore/v1.46.22)";
        }
