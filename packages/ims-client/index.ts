...
export function Environment(name: string): BaseURL {
    return `https://${name}-ims-server-pngi.encr.app`
}
...
/**
 * Client is an API client for the ims-server-pngi Encore application.
 */
...
export namespace inventory {
    ...
    export class ServiceClient {
         ...
         */
        public async createCountry(params: countries.CreateCountryDto): Promise<countries.CountryResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/countries`, JSON.stringify(params))
            return await resp.json() as countries.CountryResponse
        }
         ...
         */
        public async deleteCountry(id: number): Promise<countries.CountryResponse> {
            // Now make the actual call to the API
         ...
         */
        public async getCountry(id: number): Promise<countries.CountryResponse> {
            // Now make the actual call to the API
         ...
         */
        public async listCountries(): Promise<countries.CountriesResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/countries`)
            return await resp.json() as countries.CountriesResponse
        }
    ...
    code?: string
    active?: boolean
}): Promise<countries.CountryResponse> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "ims-server-pngi-Generated-TS-Client (Encore/v1.46.10)";
        }
