...
export namespace inventory {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getPathwayOptions = this.getPathwayOptions.bind(this)
    ...
    priceMultiplier?: number
         ...
         */
        public async createDriver(params: drivers.CreateDriverPayload): Promise<drivers.DriverWithRelations> {
            // Now make the actual call to the API
    ...
    priceMultiplier?: number
         ...
         */
        public async deleteDriver(id: number): Promise<drivers.DriverWithRelations> {
            // Now make the actual call to the API
         ...
         */
        public async getDriver(id: number): Promise<drivers.DriverWithRelations> {
            // Now make the actual call to the API
         ...
         */
        public async getPathway(id: number): Promise<pathways.PathwayWithRelations> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/pathways/${encodeURIComponent(id)}`)
            return await resp.json() as pathways.PathwayWithRelations
        }
         ...
         */
        public async getPathwayOptions(pathwayId: number): Promise<pathway_options.ListPathwayOptionsResult> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/pathways/${encodeURIComponent(pathwayId)}/options/list`)
            return await resp.json() as pathway_options.ListPathwayOptionsResult
        }
...
}): Promise<drivers.DriverWithRelations> {
            // Now make the actual call to the API
...
export namespace users {
    ...
    export interface ListUsersQueryParams {
        orderBy?: {
            field: "id" | "departmentId" | "username" | "email" | "firstName" | "lastName" | "phone" | "position" | "employeeId" | "mfaSettings" | "lastLogin" | "active" | "isSystemAdmin" | "createdAt" | "updatedAt"
            direction: "asc" | "desc"
        }[]
        filters?: {
            id?: number
    ...
    export interface PaginatedListUsersQueryParams {
        page?: number
        pageSize?: number
        orderBy?: {
            field: "id" | "departmentId" | "username" | "email" | "firstName" | "lastName" | "phone" | "position" | "employeeId" | "mfaSettings" | "lastLogin" | "active" | "isSystemAdmin" | "createdAt" | "updatedAt"
    ...
    export interface PaginatedListUsersResult {
    ...
    hasRole: boolean
        ...
        public async createUser(params: CreateUserPayload): Promise<SafeUser> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/users/create`, JSON.stringify(params))
            return await resp.json() as SafeUser
        }
        ...
        public async deleteUser(id: number): Promise<SafeUser> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/users/${encodeURIComponent(id)}/delete`)
            return await resp.json() as SafeUser
        }
         ...
         * @throws {APIError} If retrieval fails
         */
        public async listUsers(params: ListUsersQueryParams): Promise<ListUsersResult> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/users/list/all`, JSON.stringify(params))
            return await resp.json() as ListUsersResult
        }
         ...
         * @throws {APIError} If retrieval fails
         */
        public async listUsersPaginated(params: PaginatedListUsersQueryParams): Promise<PaginatedListUsersResult> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/users/list`, JSON.stringify(params))
            return await resp.json() as PaginatedListUsersResult
        }
...
export namespace drivers {
    ...
    export interface ListDriversAvailabilityQueryParams {
        ...
        orderBy?: {
            field: "id" | "driverKey" | "payrollKey" | "firstName" | "lastName" | "address" | "phone" | "email" | "hireDate" | "status" | "statusDate" | "license" | "licenseExpiry" | "busLineId" | "baseId" | "emergencyContactName" | "emergencyContactPhone" | "emergencyContactRelationship" | "createdAt" | "updatedAt"
            direction: "asc" | "desc"
        }[]
        filters?: {
            id?: number
...
export namespace pathway_options {
    export interface ListPathwayOptionsResult {
        data: PathwayOption[]
    }
    ...
    export interface PathwayOption {
         ...
         */
        tolls?: pathway_options_tolls.PathwayOptionToll[]
    }
}
...
export namespace pathways {
    ...
    export interface PathwayOptionWithTolls {
        tolls: {
            /**
             * Unique identifier for the pathway option toll
             */
...
export namespace routes {
    ...
    export interface ListRoutesQueryParams {
        orderBy?: {
            field: "id" | "code" | "name" | "description" | "serviceTypeId" | "buslineId" | "originNodeId" | "destinationNodeId" | "originCityId" | "destinationCityId" | "active" | "createdAt" | "updatedAt"
            direction: "asc" | "desc"
        }[]
        filters?: {
            id?: number
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "server-nest-8sci-Generated-TS-Client (Encore/v1.50.4)";
        }
